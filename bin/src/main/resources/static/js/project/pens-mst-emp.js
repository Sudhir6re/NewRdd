		...
		.ready(
				function() {
					...
					$(".btnSave")
							.click(
									function() {
										var checkPaybillInProcess = isPaybillIsInProcess(ppoNo);
                                         ...
                                         /*   if($("input:radio[name='chkId']").is(":checked")==false){
                                            ...
                                            if (effectiveDate == ""
												...
												$
														.ajax({
															type : "GET",
															url : "../master/savePensEmpMpgDdoAllowDeduc/"
																	+ department_allowdeduc_id
																	/*+ "/"
																	+ departmentId*/
																	+ "/"
									...
									function() {
										...
										if (input != '') {
											$
													.ajax({
														type : "GET",
														url : "../masrter/empEligibilityForAllowAndDeduct1/"
																+ input,
														async : true,
														contentType : 'application/json',
														error : function(data) {
							...
							.on(
									...
									function(e) {
										...
										$
												.ajax({
													type : "GET",
													url : "../master/empEligibilityForAllowAndDeductMappingList/"
															+ department_id,
													async : true,
													contentType : 'application/json',
													error : function(data) {
													...
													success : function(data) {
														...
														if (sevaarth_id != '') {
															$
																	.ajax({
																		type : "GET",
																		url : "../master/empEligibilityForAllowAndDeductCheckBoxId/"
																				+ ppoNo,
																		// url:
					...
					$("#dbData")
							.on(
									...
									function(e) {
										...
										// // get current row 2nd table cell TD
										// value
										ppoNo = $(this).attr("data");
										// alert("in ppoNo"+ppoNo);
										...
										if (ppoNo != '') {
											$
													.ajax({
														type : "GET",
														url : "../master/pensempEligibilityForAllowAndDeductCheckBoxId/"
																+ ppoNo,
														// url:
														// "empEligibilityForAllowAndDeductMappingList/"+department_id,
														async : true,
...
function isPaybillIsInProcess(ppoNo) {
	// alert("hello");
	var flag = 0;
	$.ajax({
		type : "GET",
		url : "../master/isPensPaybillIsInProcess/" + ppoNo,
		async : false,
		contentType : 'application/json',
		error : function(data) {
			console.log(data);
