...
@Controller
public class YearMstController {
	...
	public String loadYears(@ModelAttribute("mstYearEntity") MstYearEntity mstYearEntity,Model model) {
	...
	public String findYearById(@PathVariable Integer yearId,Model model) {
