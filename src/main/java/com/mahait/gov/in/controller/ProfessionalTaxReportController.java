...
import com.mahait.gov.in.service.ProfessionalTaxReportService;
...
@Controller
public class ProfessionalTaxReportController  extends BaseController {
	...
	@Autowired
	ProfessionalTaxReportService professionalTaxReportService;
	...
	@PostMapping("/professionalTaxReport")
	public String incomeTaxReport(@ModelAttribute("regularReportModel") RegularReportModel regularReportModel,
		...
		List<RegularReportModel> empDtls = professionalTaxReportService.findProfessionalTaxDtls(regularReportModel.getYearId(),regularReportModel.getMonthId(),
				regularReportModel.getBillGroup(),messages.getDdoCode());
		
		double totalDeduc = empDtls.stream().mapToDouble(RegularReportModel:: getProfessionalTax).sum();
