...
//	protected final Log logger = LogFactory.getLog(getClass());
	...
	public String viewApproveConsolidatedBill(@ModelAttribute("consolidatePayBillModel") ConsolidatePayBillModel consolidatePayBillModel,
										Model model,Locale locale,HttpSession session) {
		...
		model.addAttribute("lstMonths", commonHomeMethodsService.lstGetAllMonths());
		model.addAttribute("lstYears", commonHomeMethodsService.lstGetAllYears());
		consolidatePayBillModel.setLstCons(consolidatePayBillService.fetchDDOLstForConsolidateApproval(messages.getDdoCode()));
		model.addAttribute("language", locale.getLanguage());
		model.addAttribute("userId", messages.getUserId());
		model.addAttribute("consolidatePayBillModel", consolidatePayBillModel);
		addMenuAndSubMenu(model,messages);	
	...
	public String approveConsolidateBill(@ModelAttribute("consolidatePayBillModel") ConsolidatePayBillModel consolidatePayBillModel, 
			BindingResult bindingResult,RedirectAttributes redirectAttributes,Model model,Locale locale,HttpSession session) {
