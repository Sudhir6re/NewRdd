...
public class DisplayPageWiseAbstractReportModel implements Serializable {
	...
	List<DisplayPageWiseAbstractReportModel> lstDisplayPageWiseAbstractReportModel;
	...
	public List<DisplayPageWiseAbstractReportModel> getLstDisplayPageWiseAbstractReportModel() {
		return lstDisplayPageWiseAbstractReportModel;
	}
	public void setLstDisplayPageWiseAbstractReportModel(
			List<DisplayPageWiseAbstractReportModel> lstDisplayPageWiseAbstractReportModel) {
		this.lstDisplayPageWiseAbstractReportModel = lstDisplayPageWiseAbstractReportModel;
	}
	@Override
	public String toString() {
		return "DisplayPageWiseAbstractReportModel [paybillgenerationtrnid=" + paybillgenerationtrnid
				+ ", billdescription=" + billdescription + ", deptalldetNm=" + deptalldetNm + ", type=" + type
				+ ", deptallowdeducid=" + deptallowdeducid + ", tempvalue=" + tempvalue + ", tempempty=" + tempempty
				+ ", description=" + description + ", headerRow=" + headerRow + ", orderdataList=" + orderdataList
				+ ", slno=" + slno + ", allowance=" + allowance + ", lstdedectionag=" + lstdedectionag
				+ ", lstdeducother=" + lstdeducother + ", lstdeductrsy=" + lstdeductrsy + ", alnetamt=" + alnetamt
				+ ", algrosstotal=" + algrosstotal + ", algrosssale=" + algrosssale + ", algrossamt=" + algrossamt
				+ ", deductionamt=" + deductionamt + ", aldeduct_adj_try=" + aldeduct_adj_try + ", aldeduct_adj_otr="
				+ aldeduct_adj_otr + ", lstDisplayPageWiseAbstractReportModel=" + lstDisplayPageWiseAbstractReportModel
				+ "]";
	}
