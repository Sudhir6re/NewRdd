...
@Repository
public class IncomeTaxReportRepoImpl implements IncomeTaxReportRepo{
	...
	@Override
	public List<Object[]> findIncomeTaxDtls(Integer yearId, Integer monthId, Long billGroup, String ddoCode) {
		// TODO Auto-generated method stub
		Session currentSession = manager.unwrap(Session.class);
		String HQL = " select a.sevaarth_id || ' - ' || a.employee_full_name_en || '(' ||d.designation_name || ')' ,a.pan_no,b.gross_amt,b.IT" + 
