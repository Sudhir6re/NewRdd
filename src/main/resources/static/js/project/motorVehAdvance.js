...
function validateReqAmountMCA(flag){
	...
	var radioValue=$("input[name='rdoVehicleType']:checked").val();
...
/*
function selectAllCheckListMotor(){		
	
	if(document.getElementById("selectAllCheckListsM").checked){
		if(document.getElementById('ChecklistMCA').style.display == ''){
			obj = document.LNARequestProcessForm.cbDocCheckListMCA;			
			for(var i =0 ; i < obj.length;i++){
				obj[i].checked = true;
			}
