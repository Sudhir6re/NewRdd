		...
		if($("#nameoforginstt").val() =="") {
			...
			/*}else if($("#village").val() =="") {
				...
				$.ajax({
					...
					type : "GET",
					url : "../level1/EditUpdateOfficeMaster/"+OrganizationName+"/"+TelNo1+"/"+TelNo2+"/"+FaxNo+"/"+EmailId+"/"+GovtSancOrder+"/"+date+"/"+CityClass+"/"+Pincode+"/"+Town+"/"+address+"/"+institutionnumber+"/"+village+"/"+taluka,
			      ...
			      success: function(data){
			    	  ...
			    	  swal("Record Updated Successfuly !", {
			    	      icon: "success",
			    	  });
