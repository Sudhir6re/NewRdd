...
//	var totalRows = 1;
	...
	.ajax({
		type : "GET",
		url : "saveBrokenPeriodPay/" + sevaarthid + "/"+empId+"/"+fromDates+"/"+toDates+"/"+noOfDays+"/"+paybillMonth+"/"+paybillYear+"/"+basicPays+"/"+allowancesCodes+"/"+allowancesValues+"/"+deductionCodes+"/"+deductionValues+"/"+netPays+"/"+reasons+"/"+remarks+"/"+basicForCalculation+"/"+ddoCode,
		async : true,
		contentType : 'application/json',
		error : function(data) {
