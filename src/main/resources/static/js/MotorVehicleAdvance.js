...
function popupSancDtlsMCA(flag){
	...
	var tmpSanctionAmt = document.getElementById("txtSancAmountMCA").value;
	...
	if(exShowPrice==''){
		exShowPrice = document.getElementById("txtReqAmountMCA").value;
	}
